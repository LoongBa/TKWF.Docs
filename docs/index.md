...
<div class="hero-section">
  <div class="hero-badges">
    ...
    <img src="https://img.shields.io/badge/version-4.9.92-green" alt="Version 4.9.92" />
...
| 版本 | 日期 | 核心内容 |
|:-----|:-----|:---------|
| **4.9.92** | 2026-09-03 | 表结构同步调用面统一（ADR49） — 框架内置实体（Outbox/Inbox/InboxAppliedVersion/DistributedLock/JobR… |
